                                ...
                                <form action="index.php" method="post" id="currency-form">
                                    <fieldset>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <input type="number" id="currency-pounds" name="currency-pounds" value="0" required>
                                        </div>
                                        ...
                                        <div class="form-row" id="currency-old-pence-row">
                                            ...
                                            <input type="number" name="omtn-old-pence" id="currency-old-pence" step="0.01" min="0" max="11.99" value="0" >
                                        </div>

                                        <div class="form-row" id="currency-new-pence-row">
                                            <label for="omtn-new-pence">Pence</label>
                                            <input type="number" name="currency--new-pence" id="currency-new-pence" min="0" max="99" value="0">
                                        </div>

                                        <div class="form-row">
                                            <input type="submit" name="convert-currency" id="currency--submit" value="Show currency power in 2017" class="button">
                                        </div>
